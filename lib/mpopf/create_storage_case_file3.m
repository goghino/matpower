function mpcN_opf_storage = create_storage_case_file(mpc, p_storage)
    ...
    if isfield(mpc, 'storageFlexibility')
        mpcN_opf.storageFlexibility = mpc.storageFlexibility;
        mpcN_opf.FlexibilityReq = mpc.FlexibilityReq;
    end
    if isfield(mpc, 'enableDemandShift')
        mpcN_opf.enableDemandShift = mpc.enableDemandShift;
        mpcN_opf.demandShift = mpc.demandShift;
    end    
